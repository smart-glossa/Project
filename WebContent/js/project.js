...
//HEADING//
    ...
    unorder.appendChild(list1);
     ...
     var list1=document.createElement("li");
    var listnode=document.createTextNode("NEWS");
    list1.appendChild(listnode);
    unorder.appendChild(list1);
...
//---------FIRST ROW-----------//
   ...
   var picture=document.createElement("img");
   picture.setAttribute("id","pictureone");
   picture.setAttribute("src","../images/five.jpg");
   gallery.appendChild(picture);
  ...
  //--------END OF IMAGES----------//
   ...
   loadtext.setAttribute("class","load");
   var loadnode=document.createTextNode("LOAD MORE");
   loadtext.appendChild(loadnode);
   workdiv.appendChild(loadtext);
